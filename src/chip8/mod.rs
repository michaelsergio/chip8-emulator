...
impl Chip8 {
    ...
    pub fn decode_execute(&mut self, b0: u8, b1: u8) {
        ...
        if opcode == 0 {
            ...
            self.jump(arg3(b0, b1));
        } else if opcode == 2 {
            self.call(arg3(b0, b1))
        } else if opcode == 3 {
            self.se_byte(x, b1)
        } else if opcode == 4 {
            self.sne(x, b1)
            ...
            self.load_i(arg3(b0, b1))
        } else if opcode == 0xB {
            self.jump_to_v0(n as u16)
        } else if opcode == 0xC {
            self.rand(x, b1)
        } else if opcode == 0xD {
            ...
            if b1 == 0x9E {
                self.skip_if_key_pressed(x)
            } else if b1 == 0xA1 {
                self.skip_if_key_not_pressed(x)
            }
        } else if opcode == 0xF {
            if b1 == 0x07 {
                self.load_delay_timer(x)
            } else if b1 == 0x0A {
                self.load_key_press(x)
            } else if b1 == 0x15 {
